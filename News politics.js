document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initialize() {
        ...
        try {
            const response = await fetch('https://api.jsonbin.io/v3/b/68800247f7e7a370d1ec3a06');
            ...
            if (reportsData.length > 0) {
                ...
                // The initial report will now simply be the first one if Gaza-specific styling is removed
                const initialReportId = reportsData[0].id; 
    ...
    function displayReport(reportId) {
        ...
        // Removed Gaza-specific styling and effects
        const isGazaReport = false; // Always false now
        const bloodEffectClass = '';
        let bloodDripHtml = '';
