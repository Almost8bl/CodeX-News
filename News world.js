document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initializeApplication() {
        ...
        try {
            ...
            const response = await fetch('https://api.jsonbin.io/v3/b/688063fd7b4b8670d8a5bb06');
    ...
    function displayArticle(articleId) {
        ...
        mainContent.innerHTML = `
            <div class="article-detail-container bg-white p-8 md:p-10 rounded-xl shadow-2xl relative overflow-hidden">
                ...
                ${article.imageUrl ? `<img src="${article.imageUrl}" alt="${article.fullTitle}" class="w-full h-auto object-contain rounded-lg mb-8 shadow-lg border border-gray-100">` : ''}
